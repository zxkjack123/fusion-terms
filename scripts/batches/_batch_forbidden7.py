...
WRONG_ALIASES = [
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译supersonic(超声≠超音速)：正确为 超声分子束注入",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译exhaust(排气≠排放)：正确为 托卡马克排气处理系统",
    ),
    # breeder tritium extraction system → 增殖剂氚提取系统
    (
        "育种氚提取系统",
        "breeder-tritium-extraction-system",
        "zh",
        "forbidden",
        "误译breeder(增殖剂≠育种)：正确为 增殖剂氚提取系统",
    ),
    (
        "繁殖器氚提取系统",
        "breeder-tritium-extraction-system",
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译delivery(供应≠交付)：正确为 燃料储存与供应系统",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译neoclassical(新经典≠新古典)：正确为 新经典杂质输运",
    ),
    (
        "新古典杂质传输",
        "neoclassical-impurity-transport",
        "zh",
        "forbidden",
        "误译neoclassical+transport：正确为 新经典杂质输运",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译disruption(破裂≠中断)：正确为 机器学习破裂预测",
    ),
    (
        "机器学习中断预测",
        "ml-disruption-prediction",
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译transport(输运≠传输)：正确为 神经网络输运模型",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误音译+误译relaxation：正确保留 Taylor弛豫",
    ),
    (
        "泰勒弛豫",
        "taylor-relaxation",
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译construction+schedule：正确为 建造进度",
    ),
]
