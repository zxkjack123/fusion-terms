...
CONCEPTS = [
    ...
    (
        ...
        "",
        "active",
        "Ion acceleration transition region ahead of the Debye sheath",
    ),
    (
        "co-deposition",
        "concept",
        ...
        "",
        "active",
        "Simultaneous deposition of eroded material with hydrogen isotopes",
    ),
    (
        "impurity-source",
        "concept",
        ...
        "",
        "active",
        "Impurity production yield and spatial distribution at the wall",
    ),
    (
        "impurity-influx",
        "metric",
        ...
        "",
        "active",
        "Impurity flux entering plasma from wall surfaces",
    ),
    (
        "fuel-recycling",
        "concept",
        ...
        "",
        "active",
        "Hydrogen isotope adsorption-release cycle at the wall",
    ),
    (
        "wall-pumping",
        "concept",
        ...
        "",
        "active",
        "Wall hydrogen absorption causing plasma density decrease",
    ),
    (
        "deposition",
        "concept",
        ...
        "",
        "active",
        "Material deposition process on wall surfaces",
    ),
    (
        "graphite",
        "material",
        ...
        "",
        "active",
        "Legacy carbon-based PFC material",
    ),
    (
        "surface-roughening",
        "concept",
        ...
        "",
        "active",
        "Wall surface morphology roughening from plasma exposure",
    ),
    (
        "cracking",
        "concept",
        ...
        "",
        "active",
        "PFC surface cracking from thermal cycling or shock",
    ),
    ...
    (
        ...
        "",
        "active",
        "Single-pulse high heat flux damage to PFC",
    ),
    (
        "disruption-erosion",
        "concept",
        ...
        "",
        "active",
        "Severe wall erosion during plasma disruption events",
    ),
    (
        "elm-induced-erosion",
        "concept",
        ...
        "",
        "active",
        "Wall erosion caused by ELM transient heat loads",
    ),
    (
        ...
        "",
        "active",
        "Deep localized PFC damage from runaway electron impact",
    ),
    (
        "prompt-redeposition",
        "concept",
        ...
        "",
        "active",
        "Sputtered particle near-field redeposition under magnetic confinement",
    ),
    (
        "lithium-coating",
        "method",
        ...
        "",
        "active",
        "Lithium evaporation/injection wall conditioning technique",
    ),
    (
        "siliconization",
        "method",
        ...
        "",
        "active",
        "Silane glow discharge wall conditioning technique",
    ),
    (
        "dust-generation",
        "concept",
        ...
        "",
        "active",
        "Dust production mechanism from plasma erosion and flaking",
    ),
    (
        "dust-transport",
        "concept",
        ...
        "",
        "active",
        "Dust dynamics, mobilization and transport inside vacuum vessel",
    ),
    (
        "dust-inventory",
        "metric",
        ...
        "",
        "active",
        "Total mobilizable dust quantity inside vacuum vessel",
    ),
]
...
EVIDENCE = [
    (
        "presheath",
        "internal:expansion:batch-48",
        "Ion acceleration ahead of sheath",
        "copilot",
        "2026-03-21",
    ),
    (
        "co-deposition",
        "internal:expansion:batch-48",
        "Eroded material + H co-deposition",
        "copilot",
        "2026-03-21",
    ),
    (
    ...
    (
        "cracking",
        "internal:expansion:batch-48",
        "PFC surface cracking",
        "copilot",
        "2026-03-21",
    ),
    (
        "thermal-shock",
        "internal:expansion:batch-49",
        "Single-pulse HHF damage",
        "copilot",
        "2026-03-21",
    ),
    (
