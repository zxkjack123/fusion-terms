...
WRONG_ALIASES = [
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译bootstrap+fraction：正确为 自举电流份额",
    ),
    (
        "启动比例",
        "bootstrap-fraction",
