...
WRONG_ALIASES = [
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译traveling(行波≠旅行波)：正确为 行波直接能量转换器",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译odd-parity(奇宇称≠奇偶)：正确为 奇宇称旋转磁场",
    ),
    (
        "奇奇偶性旋转磁场",
        "odd-parity-rotating-magnetic-field",
        "zh",
        "forbidden",
        "误译parity：正确为 奇宇称旋转磁场",
    ),
    # neutral beam driven FRC → 中性束驱动场反
    (
        "中性光束驱动FRC",
        "neutral-beam-driven-frc",
        "zh",
        "forbidden",
        "误译beam(束≠光束)：正确为 中性束驱动场反",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译pebble bed(球床≠鹅卵石床)：正确为 氦冷球床包层",
    ),
    # fusion neutron → 聚变中子
    ...
    (
        ...
        "zh",
        "forbidden",
        "混淆composite/synthetic：正确为 碳纤维复合材料",
    ),
    # vanadium alloy → 钒合金
    ...
    (
        ...
        "zh",
        "forbidden",
        "误音译Alfvén+误译reverse(反剪切≠逆剪切)：正确为 反剪切Alfvén本征模",
    ),
    # BAE → β诱导Alfvén本征模
    (
        "β引起的阿尔芬本征模",
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译uncertainty(不确定性≠不确定度)：正确为 不确定性量化",
    ),
