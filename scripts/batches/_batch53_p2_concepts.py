...
concepts: list[tuple] = [
    ...
    ("occupational-dose", "metric", "职业剂量", "occupational dose", "", "active", "Radiation dose received by workers in a fusion facility"),

    ("# ==== Batch 53 P2: General plasma physics ====",),
    ("mean-free-path",      "metric",   "平均自由程",   "mean free path",      "", "active", "Average distance a particle travels between collisions"),
    ("cyclotron-frequency", "metric",   "回旋频率",     "cyclotron frequency",  "", "active", "Angular frequency of charged particle gyration around magnetic field line"),
    ("magnetic-pressure",   "concept",  "磁压",         "magnetic pressure",    "", "active", "Pressure exerted by magnetic field, B²/(2μ₀)"),
]
...
aliases: list[tuple] = [
    ...
    ("occupational radiation dose", "occupational-dose", "en", "alias",     "expanded form"),
    ...
    ("electron cyclotron frequency","cyclotron-frequency", "en", "alias",     "electron species"),
    ...
    ("afterheat",              "decay-heat", "en", "alias",     "synonym (residual heat after shutdown)"),
    ("residual heat",          "decay-heat", "en", "alias",     "generic synonym"),
    ("残余发热",               "decay-heat", "zh", "alias",     "residual form"),
    # plasma-equilibrium enrichment
    ("MHD equilibrium reconstruction", "plasma-equilibrium", "en", "alias", "reconstruction context"),
...
evidence: list[tuple] = [
    ...
    ("cyclotron-frequency",  "https://en.wikipedia.org/wiki/Cyclotron_resonance", "", "", TODAY),
    ("magnetic-pressure",    "https://en.wikipedia.org/wiki/Magnetic_pressure",   "", "", TODAY),
]
