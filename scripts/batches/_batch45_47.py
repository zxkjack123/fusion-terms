...
CONCEPTS = [
    ...
    (
        ...
        "",
        "active",
        "Conserved quantity describing magnetic field topology and twist",
    ),
    (
        "helicity-injection",
        "method",
        ...
        "HI",
        "active",
        "Injecting magnetic helicity to sustain plasma current",
    ),
    (
        ...
        "CHI",
        "active",
        "Coaxial gun helicity injection for spheromak/ST sustainment",
    ),
    (
        "taylor-relaxation",
        "concept",
        ...
        "",
        "active",
        "Plasma relaxation to minimum-energy state at constant helicity",
    ),
    (
        "taylor-state",
        "concept",
        ...
        "",
        "active",
        "Force-free minimum-energy equilibrium state (curl B = lambda B)",
    ),
    (
        ...
        "",
        "active",
        "Topological rearrangement of magnetic field lines releasing energy",
    ),
    (
        ...
        "",
        "active",
        "Spontaneous plasma relaxation to ordered equilibrium state",
    ),
    (
        ...
        "",
        "active",
        "Plasma equilibrium satisfying J cross B equals zero",
    ),
    (
        "tilt-instability",
        "concept",
        ...
        "",
        "active",
        "Global CT/spheromak MHD instability of magnetic axis tilt",
    ),
    (
        "flux-amplification",
        "concept",
        ...
        "",
        "active",
        "Dynamo-driven poloidal flux amplification in spheromak",
    ),
    ...
    (
        ...
        "",
        "active",
        "LLNL Sustained Spheromak Physics Experiment",
    ),
    (
        "coaxial-plasma-gun",
        "system",
        ...
        "",
        "active",
        "Coaxial magnetized gun for spheromak/CT formation",
    ),
    (
        "spheromak-merging",
        "concept",
        ...
        "",
        "active",
        "Counter-helicity spheromak merging",
    ),
    (
        "flux-conserver",
        "system",
        ...
        "",
        "active",
        "Close-fitting conducting shell for CT flux conservation",
    ),
    (
        "plasma-sustainment",
        "concept",
        ...
        "",
        "active",
        "Non-inductive current and confinement sustainment",
    ),
    (
        "pinch-parameter",
        "metric",
        ...
        "",
        "active",
        "Theta parameter characterizing RFP/spheromak state",
    ),
    (
        "exl-50u",
        "device",
        ...
        "",
        "active",
        "ENN upgraded spherical tokamak",
    ),
    ...
    (
        ...
        "",
        "active",
        "Minimum temperature required for self-sustaining fusion burn",
    ),
    (
        ...
        "",
        "active",
        "p + 11B -> 3 alpha + 8.7 MeV reaction channel",
    ),
    (
        "side-reaction",
        "concept",
        ...
        "",
        "active",
        "Parasitic neutron-producing reaction channel in advanced fuels",
    ),
    (
        ...
        "",
        "active",
        "High-temperature regime where radiation loss exceeds fusion power",
    ),
    (
        "laser-boron-fusion",
        "concept",
        ...
        "",
        "active",
        "Laser-driven p-11B fusion scheme",
    ),
    (
        "hb11-energy",
        "organization",
        ...
        "",
        "active",
        "Australian laser p-B11 fusion company",
    ),
    (
        "lpp-fusion",
        "organization",
        ...
        "",
        "active",
        "US dense plasma focus p-B11 fusion company",
    ),
    (
        ...
        "",
        "active",
        "Energy distribution spectrum of fusion reaction products",
    ),
    (
        "power-density",
        "metric",
...
EVIDENCE = [
    (
        "magnetic-helicity",
        "internal:expansion:batch-45",
        "Magnetic topology conserved quantity",
        "copilot",
        "2026-03-19",
    ),
    (
        "helicity-injection",
        "internal:expansion:batch-45",
        "Helicity injection sustainment",
        "copilot",
        "2026-03-19",
    ),
    (
    ...
    (
        "flux-amplification",
        "internal:expansion:batch-45",
        "Dynamo poloidal flux amplification",
        "copilot",
        "2026-03-19",
    ),
    (
        "sspx",
        "internal:expansion:batch-46",
        "LLNL spheromak experiment",
        "copilot",
        "2026-03-19",
    ),
    (
    ...
    (
        "ignition-temperature",
        "internal:expansion:batch-47",
        "Min self-sustaining temp",
        "copilot",
        "2026-03-19",
    ),
    (
