...
aliases: list[tuple] = [
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译gyro+scaling(标度≠缩放)：正确为 旋回Bohm标度",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译stability(稳定性≠稳定度)：正确为 理想MHD稳定性",
    ),
    (
        "理想磁流体稳定度",
        "ideal-mhd-stability",
    ...
    (
        ...
        "zh",
        "forbidden",
        "误音译Alfvén(阿尔芬≠阿尔文)：正确为 全局Alfvén本征模",
    ),
    (
        "全球Alfvén本征模",
        "global-alfven-eigenmode",
        "zh",
        "forbidden",
        "误译global(全局≠全球)：正确为 全局Alfvén本征模",
    ),
    (
        "整体Alfvén本征模",
        "global-alfven-eigenmode",
        "zh",
        "forbidden",
        "误译global(全局≠整体)：正确为 全局Alfvén本征模",
    ),
    (
        "全局阿尔芬特征模",
        "global-alfven-eigenmode",
        "zh",
        "forbidden",
        "误译eigenmode(本征模≠特征模)：正确为 全局Alfvén本征模",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译filament(丝状体≠纤维状结构)：正确为 等离子体丝状体",
    ),
    (
        "灯丝",
        "filament",
