...
NEW_CONCEPTS = [
    ...
    (
        ...
        "",
        "active",
        "Debye shielding / screening of electric charges in plasma",
    ),
    (
        "plasma-resistivity",
        "concept",
        ...
        "",
        "active",
        "Spitzer or anomalous resistivity of plasma",
    ),
    (
        "flux-coordinate",
        "concept",
        ...
        "",
        "active",
        "Coordinate system based on magnetic flux surfaces",
    ),
    (
        "field-line-tracing",
        "method",
        ...
        "",
        "active",
        "Numerical tracing of magnetic field lines",
    ),
    (
        ...
        "",
        "active",
        "Periodic core relaxation event (m=1, n=1 internal kink)",
    ),
    (
        "current-drive",
        "concept",
        ...
        "CD",
        "active",
        "Non-inductive methods for driving plasma current",
    ),
    (
        "triple-product",
        "metric",
        ...
        "",
        "active",
        "nTτ_E figure of merit for fusion plasmas",
    ),
    ...
    (
        ...
        "LHH",
        "active",
        "Heating via lower hybrid waves",
    ),
    (
        ...
        "NBCD",
        "active",
        "Current drive via neutral beam injection",
    ),
    # -- confinement --
    (
        ...
        "",
        "active",
        "Time scale for plasma energy loss",
    ),
    (
        "ignition-condition",
        "concept",
        ...
        "",
        "active",
        "Condition for self-sustained fusion burn",
    ),
    # -- divertor/SOL --
    (
        "detachment",
        ...
        "",
        "active",
        "Plasma detachment from divertor target",
    ),
    (
        "high-recycling",
        "concept",
        ...
        "",
        "active",
        "High recycling regime in SOL/divertor",
    ),
    (
        "sheath",
        "concept",
        ...
        "",
        "active",
        "Plasma boundary sheath at material surfaces",
    ),
    # -- blanket --
    (
        "ceramic-breeder",
        ...
        "",
        "active",
        "Ceramic lithium compound for tritium breeding (Li4SiO4, Li2TiO3)",
    ),
    (
        "wcll",
        "system",
        ...
        "WCLL",
        "active",
        "EU water-cooled lithium-lead blanket concept",
    ),
    # -- safety --
    (
        ...
        "LOVA",
        "active",
        "Design basis accident: loss of vacuum boundary integrity",
    ),
    # -- neutronics --
    (
        "neutron-activation",
        ...
        "",
        "active",
        "Activation of materials by neutron irradiation",
    ),
    (
        "neutron-camera",
        "diagnostic",
        ...
        "",
        "active",
        "Spatially-resolved neutron emission diagnostic",
    ),
    # -- stellarator --
    (
        "helias",
        ...
        "",
        "active",
        "Helical-axis advanced stellarator concept",
    ),
    (
        ...
        "QSS",
        "active",
        "Stellarator with quasi-symmetry in |B|",
    ),
    # -- power plant --
    (
        "coolant-loop",
        ...
        "",
        "active",
        "Primary/secondary coolant circulation loop",
    ),
    (
        ...
        "PCS",
        "active",
        "Heat-to-electricity conversion system",
    ),
    (
        "maintenance-period",
        "metric",
        ...
        "",
        "active",
        "Scheduled maintenance interval for fusion plant",
    ),
    # -- simulation --
    (
        ...
        "",
        "active",
        "First-principles simulation of plasma micro-turbulence",
    ),
]
...
NEW_EVIDENCE = [
    ...
    (
        "flux-coordinate",
        f"internal:expansion:{BATCH}",
        "Magnetic flux coordinate system",
        AUTHOR,
        DATE,
    ),
    (
        "field-line-tracing",
        f"internal:expansion:{BATCH}",
        "Magnetic field line tracing method",
        AUTHOR,
        DATE,
    ),
    (
        "sawtooth-instability",
        f"internal:expansion:{BATCH}",
        "Internal kink sawtooth oscillation",
        AUTHOR,
        DATE,
    ),
    (
        "current-drive",
        f"internal:expansion:{BATCH}",
        "Non-inductive plasma current drive",
        AUTHOR,
        DATE,
    ),
    (
    ...
    (
        "ignition-condition",
        f"internal:expansion:{BATCH}",
        "Self-sustained fusion ignition",
        AUTHOR,
        DATE,
    ),
    (
    ...
    (
        "high-recycling",
        f"internal:expansion:{BATCH}",
        "High recycling divertor regime",
        AUTHOR,
        DATE,
    ),
    (
    ...
    (
        "ceramic-breeder",
        f"internal:expansion:{BATCH}",
        "Li4SiO4/Li2TiO3 ceramic breeder",
        AUTHOR,
        DATE,
    ),
    ...
    (
        "neutron-camera",
        f"internal:expansion:{BATCH}",
        "Spatially resolved neutron diagnostic",
        AUTHOR,
        DATE,
    ),
    (
    ...
    (
        "quasi-symmetric-stellarator",
        f"internal:expansion:{BATCH}",
        "Quasi-symmetry optimized stellarator",
        AUTHOR,
        DATE,
    ),
    (
        "coolant-loop",
        f"internal:expansion:{BATCH}",
        "Primary/secondary coolant loop",
        AUTHOR,
        DATE,
    ),
    (
...
def main():
    ...
    print(
        f"  aliases.tsv:  appended {len(alias_data)} data + {len(NEW_ALIASES) - len(alias_data)} comment rows"
    )

    enrich_data = [r for r in ENRICH_ALIASES if len(r) > 1]
    write_tsv_rows(ALIASES_TSV, ENRICH_ALIASES)
    print(
        f"  aliases.tsv:  appended {len(enrich_data)} enrichment aliases + {len(ENRICH_ALIASES) - len(enrich_data)} comment rows"
    )
