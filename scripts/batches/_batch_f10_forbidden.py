...
DATA = [
    ...
    (
        ...
        "zh",
        "forbidden",
        "遮蔽 not standard for plasma shielding",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "回收=recovery/recycling of materials",
    ),
    (
        "高循环",
        "high-recycling",
    ...
    (
        ...
        "zh",
        "forbidden",
        "Taiwan transliteration, non-standard",
    ),
    (
        "蒙地卡罗法",
        "monte-carlo-method",
    ...
    (
        ...
        "zh",
        "forbidden",
        "激活=activate a system, not nuclear activation",
    ),
    (
        "中子激发",
        "neutron-activation",
        "zh",
        "forbidden",
        "激发=excitation, different process",
    ),
    # plasma-resistivity
    (
        "等离子体阻率",
    ...
    (
        ...
        "zh",
        "deprecated",
        "missing 体; standard form is 等离子体电阻率",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "literal translation of 'lower hybrid'",
    ),
    (
        "低杂交波加热",
        "lower-hybrid-heating",
    ...
    (
        ...
        "zh",
        "forbidden",
        "保养=vehicle/appliance maintenance",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "AI translates code name as Corsica island",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "AI translates code name as Tripoli city",
    ),
]
...
if __name__ == "__main__":
    ...
    print(
        f"Wrote {n} aliases ({forbidden} forbidden + {deprecated} deprecated) "
