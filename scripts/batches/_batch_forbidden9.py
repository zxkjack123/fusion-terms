...
WRONG_ALIASES = [
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译Technologies(应保留英文)：正确为 TAE Technologies",
    ),
    (
        "TAE科技",
        "tae-technologies",
        "zh",
        "forbidden",
        "误译Technologies：正确为 TAE Technologies",
    ),
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译fusion+facility：正确为 国际聚变材料辐照装置",
    ),
    # SG-III → 神光三号
    ...
    (
        ...
        "zh",
        "forbidden",
        "误译Upgrade(装置名应保留 ASDEX Upgrade)",
    ),
    # KSTAR
